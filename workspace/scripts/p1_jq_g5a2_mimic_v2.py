...
OUTPUT_DIR = PROJECT_ROOT / "workspace/research/alpha_mining/p1_jq_g5a2_mimic_v2_smb_only_run"

# v2 (2026-05-20): restrict universe to 002/003 ONLY (原中小板) to match JoinQuant's
# get_index_stocks('399101.XSHE') which returns ONLY 中小板 names. The v1 mimic
# unintentionally included 主板 (00/60) + ChiNext (300), making 80% of buys
# OUTSIDE JoinQuant's actual 中小综 pool. v2 expected universe size: ~500-1000.
...
def compute_rebalance_schedule(
    ...
    LOGGER.info(f"Schedule built: {len(schedule)} rebalance dates")
    return schedule
