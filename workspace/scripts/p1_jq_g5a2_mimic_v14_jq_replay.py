...
LOGGER = logging.getLogger("p1_jq_mimic_v14")

START_DATE = pd.Timestamp("2014-01-01")
END_DATE = pd.Timestamp("2026-02-27")
INITIAL_CAPITAL = 100_000.0
BENCHMARK = "000300.SH"
SLIPPAGE_BPS = 3.0 / 10000.0
...
OUTPUT_DIR = PROJECT_ROOT / "workspace/research/alpha_mining/p1_jq_g5a2_mimic_v14_jq_replay_run"
