...
LOGGER = logging.getLogger("p1_jq_mimic_v12")
...
OUTPUT_DIR = PROJECT_ROOT / "workspace/research/alpha_mining/p1_jq_g5a2_mimic_v12_no_survivor_run"
...
RESTRICT_TO_SURVIVORS_ONLY = False  # v12: turn OFF — test whether JQ uses full historical universe (including delisted-pre-2024 names)
