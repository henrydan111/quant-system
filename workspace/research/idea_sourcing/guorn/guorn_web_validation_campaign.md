...
| 16 | DivGrPY% | doable | — derive — | 2 | ⬜ pending |  |
...
| 24 | 10日融资偿还金额 | doable | — derive — | 1 | ⬜ pending |  |
| 25 | 管理层持股比例 | doable | — derive — | 1 | ⬜ pending |  |
| 26 | 20日换手率 | doable | — derive — | 1 | ⬜ pending |  |
| 27 | 交易天数 | doable | — derive — | 1 | ⬜ pending |  |
| 28 | RND%Assets | validated | `TTM($rd_exp_sq)/mean($total_assets_q0.. | 1 | ⬜ pending |  |
| 29 | 连续N年分红(3) | doable | — derive — | 1 | ⬜ pending |  |
...
| 36 | RnDTTMGr%PY | doable | — derive — | 1 | ⬜ pending |  |
