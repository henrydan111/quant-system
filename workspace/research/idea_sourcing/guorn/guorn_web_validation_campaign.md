...
> One export per factor, deployed-20 first, highest-usage first. **56 web-validatable factors** (2 done / 54 pending). Resumable: status lives in `guorn_web_validation_campaign.json`; re-run `build_guorn_validation_campaign.py` to re-seed (preserves status). NON-FORMAL.
...
| 20 | 股息率TTM | validated | `$dv_ttm` (lag T−1, scale 100) | 2 | ⬜ pending |  |
| 21 | 贝塔N日(000001,250) | doable | — derive — | 2 | ⬜ pending |  |
| 22 | 研发销售比率 | doable | — derive — | 2 | ⬜ pending |  |
| 23 | AssetTurnoverDiffPY | doable | — derive — | 2 | ⬜ pending |  |
| 24 | 财报预约公布天数 | doable | — derive — | 1 | ⬜ pending |  |
| 25 | 20日涨幅 | doable | — derive — | 1 | ⬜ pending |  |
| 26 | CoreProfitQ | validated | `$revenue_sq_q0 − $oper_cost_sq_q0 − ($a | 1 | ⬜ pending |  |
| 27 | 交易天数 | doable | — derive — | 1 | ⬜ pending |  |
| 28 | 20日换手率 | doable | — derive — | 1 | ⬜ pending |  |
| 29 | RND%Assets | validated | `TTM($rd_exp_sq)/mean($total_assets_q0.. | 1 | ⬜ pending |  |
| 30 | 10日融资偿还金额 | doable | — derive — | 1 | ⬜ pending |  |
| 31 | 管理层持股比例 | doable | — derive — | 1 | ⬜ pending |  |
| 32 | 波动率_日度指标(分红总金额,720) | doable | — derive — | 1 | ⬜ pending |  |
| 33 | 连续N年分红(3) | doable | — derive — | 1 | ⬜ pending |  |
| 34 | DivOP% | doable | — derive — | 1 | ⬜ pending |  |
| 35 | YieldRfrDiff | doable | — derive — | 1 | ⬜ pending |  |
| 36 | 预期盈利增长率 | doable | — derive — | 1 | ⬜ pending |  |
| 37 | 5日平均溢价率 | doable | — derive — | 1 | ⬜ pending |  |
| 38 | 财报发布天数 | doable | — derive — | 1 | ⬜ pending |  |
| 39 | RoeQ | doable | — derive — | 1 | ⬜ pending |  |
| 40 | 机构持股比例 | doable | — derive — | 1 | ⬜ pending |  |
| 41 | RnDTTMGr%PY | doable | — derive — | 1 | ⬜ pending |  |
| 42 | Div%NetIncY2 | doable | — derive — | 1 | ⬜ pending |  |
| 43 | DivAGrPY% | doable | — derive — | 1 | ⬜ pending |  |
| 44 | EpsTTMGr% | doable | — derive — | 1 | ⬜ pending |  |
| 45 | AH股溢价率 | doable | — derive — | 1 | ⬜ pending |  |
| 46 | 市研率 | doable | — derive — | 1 | ⬜ pending |  |
| 47 | ATR%收盘价N日(20) | doable | — derive — | 1 | ⬜ pending |  |
| 48 | sortinoN日(250) | doable | — derive — | 1 | ⬜ pending |  |
| 49 | sortinoN日(120) | doable | — derive — | 1 | ⬜ pending |  |
| 50 | 60日波动率 | doable | — derive — | 1 | ⬜ pending |  |
| 51 | 120日涨幅 | doable | — derive — | 1 | ⬜ pending |  |
| 52 | 近期评级变化 | doable | — derive — | 1 | ⬜ pending |  |
| 53 | 评级增持家数 | doable | — derive — | 1 | ⬜ pending |  |
| 54 | 分析师评级分 | doable | — derive — | 1 | ⬜ pending |  |
| 55 | 总市值 | validated | `$total_mv` (万元) | 8 | ✅ done | ◑ structure-exact: Spearman 0.999 / Pear |
