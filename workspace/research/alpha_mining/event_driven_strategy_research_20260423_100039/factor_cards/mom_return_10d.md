# Factor Card: mom_return_10d

## Basic Info
- Category: `Momentum`
- Signal direction in strategy: `low_is_good`
- Raw expression: `Ref(($close * $adj_factor), 1) / Ref(($close * $adj_factor), 11) - 1`
...
## Quantile Diagnostic
- Long-short annualized diagnostic return: `-71.19%`
- Long-short total diagnostic return: `-100.00%`
- Long-short Sharpe: `-4.535`
- Monotonic: `False`
- Monotonic Spearman: `-0.700`
| quantile | mean_daily_return | annualized_return | volatility | sharpe | n_days |
| --- | --- | --- | --- | --- | --- |
| 1.000 | 0.004 | 1.111 | 0.742 | 1.497 | 2,948 |
| 2.000 | 0.005 | 1.270 | 0.697 | 1.823 | 2,948 |
| 3.000 | 0.005 | 1.157 | 0.668 | 1.733 | 2,948 |
| 4.000 | 0.004 | 0.931 | 0.658 | 1.415 | 2,948 |
| 5.000 | -0.000 | -0.091 | 0.689 | -0.132 | 2,948 |

## Correlation And Redundancy
| fold_id | peer_factor | abs_corr | cluster_id |
| --- | --- | --- | --- |
| fold_01_2021 | selected_cluster_peer | 0.503 | selected_cluster |
| fold_02_2022 | selected_cluster_peer | 0.716 | selected_cluster |
| fold_03_2023 | selected_cluster_peer | 0.709 | selected_cluster |
| fold_04_2024 | selected_cluster_peer | 0.688 | selected_cluster |
| fold_05_2025 | selected_cluster_peer | 0.669 | selected_cluster |

## Marginal IC
| fold_id | base_factor_count | marginal_mean_rank_ic | marginal_rank_icir |
| --- | --- | --- | --- |
| fold_01_2021 | 10 | 0.001 | 0.025 |
| fold_02_2022 | 10 | -0.012 | -0.223 |
| fold_03_2023 | 10 | -0.010 | -0.200 |
| fold_04_2024 | 10 | -0.015 | -0.327 |
| fold_05_2025 | 10 | -0.019 | -0.260 |
