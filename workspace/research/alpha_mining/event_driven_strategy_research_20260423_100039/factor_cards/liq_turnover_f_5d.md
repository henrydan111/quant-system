...
| --- | --- | --- | --- |
| fold_01_2021 | selected_cluster_peer | 0.425 | selected_cluster |
| fold_02_2022 | selected_cluster_peer | 0.406 | selected_cluster |
| fold_03_2023 | selected_cluster_peer | 0.903 | selected_cluster |
| fold_04_2024 | selected_cluster_peer | 0.910 | selected_cluster |
| fold_05_2025 | selected_cluster_peer | 0.913 | selected_cluster |

## Marginal IC
| fold_id | base_factor_count | marginal_mean_rank_ic | marginal_rank_icir |
| --- | --- | --- | --- |
| fold_01_2021 | 2 | -0.042 | -0.568 |
| fold_02_2022 | 2 | -0.033 | -0.625 |
| fold_03_2023 | 2 | -0.001 | -0.014 |
| fold_04_2024 | 4 | 0.015 | 0.367 |
