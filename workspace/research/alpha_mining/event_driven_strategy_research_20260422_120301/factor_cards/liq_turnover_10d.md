...
| --- | --- | --- | --- |
| fold_01_2021 | selected_cluster_peer | 0.874 | selected_cluster |
| fold_02_2022 | selected_cluster_peer | 0.865 | selected_cluster |
| fold_03_2023 | selected_cluster_peer | 0.966 | selected_cluster |
| fold_04_2024 | selected_cluster_peer | 0.964 | selected_cluster |
| fold_05_2025 | selected_cluster_peer | 0.964 | selected_cluster |

## Marginal IC
| fold_id | base_factor_count | marginal_mean_rank_ic | marginal_rank_icir |
| --- | --- | --- | --- |
| fold_01_2021 | 5 | -0.005 | -0.128 |
| fold_02_2022 | 4 | 0.000 | 0.001 |
| fold_03_2023 | 2 | 0.000 | 0.004 |
| fold_04_2024 | 3 | 0.001 | 0.034 |
