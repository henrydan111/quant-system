...
| fold_03_2023 | 0.720 | 0.856 | 0.783 | 1 | 1 | True | True | False |  |
| fold_04_2024 | 0.689 | 0.812 | 0.711 | 1 | 1 | True | True | False |  |
...
| --- | --- | --- | --- |
| fold_01_2021 | selected_cluster_peer | 0.572 | selected_cluster |
| fold_02_2022 | selected_cluster_peer | 0.596 | selected_cluster |
| fold_03_2023 | selected_cluster_peer | 0.649 | selected_cluster |
| fold_04_2024 | selected_cluster_peer | 0.612 | selected_cluster |
| fold_05_2025 | selected_cluster_peer | 0.584 | selected_cluster |

## Marginal IC
| fold_id | base_factor_count | marginal_mean_rank_ic | marginal_rank_icir |
| --- | --- | --- | --- |
| fold_01_2021 | 5 | 0.014 | 0.228 |
| fold_02_2022 | 2 | 0.024 | 0.398 |
| fold_03_2023 | 2 | 0.025 | 0.400 |
| fold_04_2024 | 3 | 0.022 | 0.359 |
