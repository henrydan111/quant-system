...
- Primary coverage: `53.78%`

## Fold Metrics
| fold_id | train_icir | val_icir | test_icir | train_direction | val_direction | direction_consistent | validation_pass | selected | selection_reason |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fold_01_2019 |  | 0.270 | 0.315 | 1 | 1 | True | True | False |  |
| fold_02_2020 | 0.161 | 0.350 | -0.074 | 1 | 1 | True | True | False |  |
| fold_03_2021 | 0.270 | 0.114 | 0.114 | 1 | 1 | True | False | False |  |
| fold_04_2022 | 0.282 | 0.026 | -0.053 | 1 | 1 | True | False | False |  |
| fold_05_2023 | 0.196 | 0.031 | 0.270 | 1 | 1 | True | False | False |  |
| fold_06_2024 | 0.179 | 0.103 | 0.224 | 1 | 1 | True | False | False |  |
| fold_07_2025 | 0.134 | 0.254 |  | 1 | 1 | True | True | False |  |
...
| --- | --- | --- | --- |
| fold_01_2019 | selected_cluster_peer | 0.020 | selected_cluster |
| fold_02_2020 | selected_cluster_peer | 0.030 | selected_cluster |
| fold_07_2025 | selected_cluster_peer | 0.030 | selected_cluster |

## Marginal IC
| fold_id | base_factor_count | marginal_mean_rank_ic | marginal_rank_icir |
| --- | --- | --- | --- |
| fold_01_2019 | 10 | 0.003 | 0.084 |
| fold_02_2020 | 10 | -0.002 | -0.075 |
| fold_07_2025 | 10 | 0.002 | 0.075 |
