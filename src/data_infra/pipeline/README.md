...
init_factor_data.py        # Phase 3 bootstrap: extra datasets for the 177-factor catalog
...
- Downloads the additional Phase 3 datasets needed for the 177-factor catalog:
  - `cashflow`
  - `forecast`
  - `moneyflow`
  - `hk_hold`
